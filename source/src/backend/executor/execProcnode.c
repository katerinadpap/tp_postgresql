...
#include "executor/nodeTimeAdjustment.h" // TPDB - KATERINA
...
ExecInitNode(Plan *node, EState *estate, int eflags) {
	...
	// TPDB - KATERINA
	// Calls the execution methods to apply the time adjustment, 1st round (of 3)
	case T_Normalization:
	case T_Alignment:
		result = (PlanState *) ExecInitAdjustmentWrapper(node, estate, eflags);
		break;
	case T_NegatingWindows: /* NEGATING */
		result = (PlanState *) ExecInitAdjustmentWrapper(node, estate, eflags);
		break;
...
ExecProcNode(PlanState *node) {
	...
	// printf("\n\nWHAT IS THE NODE BEING EXECUTED? ---- %d\n\n", nodeTag(node));
	 ...
	 */
	case T_ResultState:
	    // printf("----------  WE ARE HERE (T_ResultState) -----------\n");
		result = ExecResult((ResultState *) node);
		break;

	case T_ModifyTableState:
		// printf("----------  WE ARE HERE (T_ModifyTableState) -----------\n");
		result = ExecModifyTable((ModifyTableState *) node);
		break;

	case T_AppendState:
		// printf("----------  WE ARE HERE (T_AppendState) -----------\n");
		result = ExecAppend((AppendState *) node);
		break;

	case T_MergeAppendState:
		// printf("----------  WE ARE HERE (T_MergeAppendState) -----------\n");
		result = ExecMergeAppend((MergeAppendState *) node);
		break;

	case T_RecursiveUnionState:
		// printf("----------  WE ARE HERE (T_RecursiveUnionState) -----------\n");
		 ...
		 */
	case T_SeqScanState:
		// printf("----------  WE ARE HERE (T_SeqScanState) -----------\n");
		result = ExecSeqScan((SeqScanState *) node);
		break;

	case T_IndexScanState:
		// printf("----------  WE ARE HERE (T_IndexScanState) -----------\n");
		result = ExecIndexScan((IndexScanState *) node);
		break;

	case T_IndexOnlyScanState:
		// printf("----------  WE ARE HERE (T_IndexOnlyScanState) -----------\n");
	...
	case T_BitmapHeapScanState:
		// printf("----------  WE ARE HERE (T_BitmapHeapScanState) -----------\n");
		result = ExecBitmapHeapScan((BitmapHeapScanState *) node);
		break;

	case T_TidScanState:
		// printf("----------  WE ARE HERE (T_TidScanState) -----------\n");
	...
	case T_FunctionScanState:
		// printf("----------  WE ARE HERE (T_SubqueryScanState) -----------\n");
		result = ExecFunctionScan((FunctionScanState *) node);
		break;

	case T_ValuesScanState:
		// printf("----------  WE ARE HERE (T_ValuesScanState) -----------\n");
		result = ExecValuesScan((ValuesScanState *) node);
		break;

	case T_CteScanState:
		// printf("----------  WE ARE HERE (T_CteScanState) -----------\n");
		result = ExecCteScan((CteScanState *) node);
		break;

	case T_WorkTableScanState:
		// printf("----------  WE ARE HERE (T_WorkTableScanState) -----------\n");
		result = ExecWorkTableScan((WorkTableScanState *) node);
		break;

	case T_ForeignScanState:
		// printf("----------  WE ARE HERE (T_ForeignScanState) -----------\n");
	...
	case T_NestLoopState:
		// printf("----------  WE ARE HERE (T_NestLoopState) -----------\n");
		result = ExecNestLoop((NestLoopState *) node);
		break;

	case T_MergeJoinState:
		// printf("----------  WE ARE HERE (T_MergeJoinState) -----------\n");
		result = ExecMergeJoin((MergeJoinState *) node);
		break;

	case T_HashJoinState:
		// printf("----------  WE ARE HERE (T_HashJoinState) -----------\n");
	...
	case T_MaterialState:
		// printf("----------  WE ARE HERE (T_MaterialState) -----------\n");
		result = ExecMaterial((MaterialState *) node);
		break;

	case T_SortState:
		// printf("----------  WE ARE HERE (T_SortState) -----------\n");
		result = ExecSort((SortState *) node);
		break;

	case T_GroupState:
		// printf("----------  WE ARE HERE (T_GroupState) -----------\n");
		result = ExecGroup((GroupState *) node);
		break;

	case T_AggState:
		// printf("----------  WE ARE HERE (T_AggState) -----------\n");
		result = ExecAgg((AggState *) node);
		break;

	case T_WindowAggState:
		// printf("----------  WE ARE HERE (T_WindowAggState) -----------\n");
		result = ExecWindowAgg((WindowAggState *) node);
		break;

	case T_UniqueState:
		// printf("----------  WE ARE HERE (T_UniqueState) -----------\n");
		result = ExecUnique((UniqueState *) node);
		break;

	case T_HashState:
		// printf("----------  WE ARE HERE (T_HashState) -----------\n");
		result = ExecHash((HashState *) node);
		break;

	case T_SetOpState:
		// printf("----------  WE ARE HERE (T_SetOpState) -----------\n");
		result = ExecSetOp((SetOpState *) node);
		break;

	case T_LockRowsState:
		// printf("----------  WE ARE HERE (T_LockRowsState) -----------\n");
		result = ExecLockRows((LockRowsState *) node);
		break;

	case T_LimitState:
		// printf("----------  WE ARE HERE (T_LimitState) -----------\n");
		result = ExecLimit((LimitState *) node);
		break;

		// TPDB - KATERINA
		// Calls the execution methods to apply the absorption / time adjustment
		// 2nd round (of 3)
	// case T_TimeAbsorptionState:
	// 	result = ExecAbsorb((UniqueState *) node);
	// 	break;

	case T_TimeAdjustmentState:
	    // printf("----------  Exec_Proc_Node (%d)  -----------\n", ((TimeAdjustmentState *) node)->windowsToBeProduced);
		result = ExecAdjustment((TimeAdjustmentState *) node);
	    // printf("----------  Exec_Proc_Node (%d) OVER  -----------\n\n\n", ((TimeAdjustmentState *) node)->windowsToBeProduced);
		break;
...
void ExecEndNode(PlanState *node) {
	...
	case T_LimitState:
		...
		// Last (3rd) round
	// case T_TimeAbsorptionState:
	// 	ExecEndAbsorb((UniqueState *) node);
	// 	break;

	case T_TimeAdjustmentState:
		ExecEndAdjustment((TimeAdjustmentState *) node);
		break;
