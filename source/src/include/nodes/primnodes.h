...
/* TPDB - KATERINA */
typedef struct TimeAdjustmentExpr
{
	NodeTag 	type;
	int 		timeAdjustmentType;		// type of time adjustment (normalization or alignment)
										// 1 -> Normalize, 2 -> Alignment, 3 -> Normalize theta
										// 4, 5 -> Set Operations, 6-> Unmatched/Overlapping/Negating Windows, 
	List	   *usingClause;			// USING clause, if any (list of String)
	Node	   *quals;					// qualifiers on join, if any
	int 		numOfLeftCols;				// number of columns in the left relation
