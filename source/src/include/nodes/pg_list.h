...
#include "postgres.h" /* TPDB - KATERINA */
...
/* TPDB - KATERINA */
/* This struct was created to store information of the form
   (te, lineage_expression) */
typedef struct
{
	Datum objA; //ts
	Datum objB; //te
...
#define list_make5(x1,x2,x3,x4,x5)	lcons(x1, list_make4(x2, x3, x4,x5)) // TPDB - KATERINA
...
extern List *lprepend(List *list, void *datum); /* TPDB - Katerina - */
...
/* TPDB KATERINA */
extern ListCell* get_previous(const List *list, const void *te_check); /* TPDB - KATERINA */
extern List* delete_all_less_than(const List *list, const void *te_check); /* TPDB - KATERINA */
