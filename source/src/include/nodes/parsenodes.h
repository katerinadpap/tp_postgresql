...
typedef struct Query
{
	...
	/* TPDB - KATERINA */
	Node 	   *timeAdjustmentOperation; 	/* timeAdjustment node if this is a timeAdjustment statement */
	List       *timeAbsorptionClause; 		/* absorb Clause if any */
...
/* TPDB - KATERINA */
typedef enum LineageType
{
	LINEAGE_NONE,		//Nothing is computed
	LINEAGE_CONF,		//Only conf is displayed
	LINEAGE_LINEAGE,	//Only lineage is displayed
	LINEAGE_BOTH		//Conf & lineage is displayed
} LineageType;

/* TPDB - KATERINA */
typedef enum DimensionType
{
	DIMENSION_NONE,		//Nothing is computed
	DIMENSION_TP		//
} DimensionType;
...
typedef struct SelectStmt
{
	...
	/* TPDB - KATERINA */
	Node 		*timeAdjustmentOperation;			/* if non-null this is a timeAdjustment statement */
	List    	*timeAbsorptionClause;
	LineageType	lineage_type;
	DimensionType	dimension_type; 
	bool		isTopLevelStmt;				/* if true the Stmt is the top one, we transform the facts of the join and LINEAGE/CONF are displayed */
