...
extern TupleHashEntry FindTupleHashEntry(TupleHashTable hashtable,
				   ...
				   FmgrInfo *eqfunctions,
				   FmgrInfo *hashfunctions);
extern bool execTuplesMatchAtPos(TupleTableSlot *slot1,
								 TupleTableSlot *slot2,
								 int att,
								 FmgrInfo *eqfunctions,
								 MemoryContext evalContext);
extern bool execTuplesMatchFromPosToPos(TupleTableSlot *slot1,
				TupleTableSlot *slot2,
				int pos1, int pos2,
				AttrNumber *matchColIdx,
				FmgrInfo *eqfunctions,
				MemoryContext evalContext); /* TPDB */

bool execTuplesMatchFacts(TimeAdjustmentState *node, Alignment *plannode,
						  TupleTableSlot *upcoming, TupleTableSlot *cur_group, int neg);
...
extern int ExecAssignResultTypeFromTL_test(PlanState *planstate);
